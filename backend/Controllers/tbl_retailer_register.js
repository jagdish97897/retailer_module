...
const updateShopStatus= async (req, res) => {
  ...
  const loginRetailer = (req, res) => {
    ...
    const query = "SELECT * FROM tbl_retailer_register WHERE Reg_no = ? AND Status = 'Active'"; 
...
module.exports = { addRetailer, getRetailerByRegNo, updateRetailer, updateRetailerStatus, updatePassword, updateDocuments, viewAllShops,updateShopStatus, loginRetailer,logoutRetailer };
